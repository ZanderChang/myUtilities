...
@.str.1.3 = private unnamed_addr constant [3 x i8] c"B\0A\00", align 1
@.str.2.4 = private unnamed_addr constant [4 x i8] c"HH\0A\00", align 1
...
if.then2:                                         ; preds = %if.end
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1.3, i32 0, i32 0))
  br label %if.end4
...
if.end:                                           ; preds = %if.then, %entry
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2.4, i32 0, i32 0))
  ret i32 0
}
